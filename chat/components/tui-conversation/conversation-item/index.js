    ...
    conversation: {
      ...
      observer(conversation) {
        ...
        that.setData({
          ...
          setConversationAvatar: that.setConversationAvatar(conversation),
        });
        that.$updateTimeAgo(conversation);
        that.setPinName(conversation.isPinned);
        console.log(that.data.conversationName)
        wx.request({
          ...
          success: function (res) {
            ...
            that.setData({
              ...
              setConversationAvatar: res.data[0].avatarUrl,
            });
          }
        }) 
      },
